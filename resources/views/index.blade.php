...
<body class="m-0 p-0 h-[680px] font-sans">
    ...
    <nav class="bg-black shadow-md">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                <a href=""><h2 class="text-white text-2xl">Social Investment</h2></a>
                ...
                <div class="hidden md:flex space-x-8">
                    ...
                    <div class="auth-option mt-2">
                        <a href="{{route('loginForm')}}"
                            class="text-white text-xl hover:text-yellow-400 px-3 py-2 rounded-md text-sm font-medium">Login</a>
                    </div>
                    <div class="auth-option mt-2">
                        <a href="{{route('signupForm')}}"
                            class="text-white text-xl hover:text-yellow-400 px-3 py-2 rounded-md text-sm font-medium">Sign
                            Up</a>
                    </div>
                    </a>
                </div>
    ...
    <div class="relative flex items-center justify-center h-full bg-cover bg-center text-white text-center"
        ...
        <div class="relative z-10 max-w-lg animate-fadeIn">
            ...
            <p class="text-lg md:text-2xl my-5 animate-slideInFromRight">Invest in Social Causes, Startups, and
                Community Projects</p>
            {{-- <a href="#loginSignup"
                class="inline-block px-6 py-3 mt-5 bg-transparent border-2 text-white text-xl rounded hover:border-green-300 hover:bg-green-600 transition duration-300 ease-in-out animate-bounceIn">Raise
                Fund</a> --}}
            <a href="{{ route('loginForm') }}"
                class="inline-block px-6 py-3 mt-5 bg-transparent border-2 text-white text-xl rounded hover:border-green-300 hover:bg-green-600 transition duration-300 ease-in-out animate-bounceIn">Raise
                Fund</a>
    ...
    <section class="py-8 bg-">
        <div class="container mx-auto mt-4">
            ...
            <div class="flex flex-wrap justify-center gap-8">
                <div
                    class="card bg-white shadow-md rounded-lg overflow-hidden w-full sm:w-96 transform transition duration-500 hover:scale-105 hover:shadow-lg">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4">Help today because tomorrow you may be the one who needs helping!
                        </p>
                        <a href="#"
                            class="inline-block px-6 py-3 mt-5 bg-green-400 text-white text-xl rounded hover:bg-green-500 transition duration-300 ease-in-out">Learn
                            more</a>
                    </div>
                </div>
                <div
    ...
    <div class="container mx-auto p-8">
        <h1 class="text-3xl font-bold text-gray-800 mb-6 text-center">Vision and Scope of Social Investment Platform
        </h1>
            ...
            <div class="bg-yellow-100 rounded-lg p-6 shadow-md">
                <div class="flex items-center mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-red-500" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M12 4.354a4 4 0 110 5.292m0 2.502a9 9 0 110 12.998" />
                    </svg>
                ...
                <div class="mt-6">
                    <img src="https://images.unsplash.com/photo-1550745165-9bc0b252726f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=687&q=80"
                        alt="Target Audience" class="rounded-full w-40 h-40">
                </div>
            </div>
        </div>
        ...
        <div class="container mx-auto px-4">
            <div class="flex flex-wrap justify-between">
                ...
                <div class="w-full sm:w-1/2 lg:w-1/4 mb-8">
                    ...
                    <p class="text-white">We are a platform dedicated to connecting people with social causes, fostering
                        community engagement, and driving impactful change.</p>
                </div>
